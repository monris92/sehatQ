...
class loginAndroid {
	...
	def inputEmail(String Email) {
		Mobile.setText(findTestObject('android/Login/inputEmailLogin'), Email, 0)
	}

	@And("user input (.*)password name form")
	def inputPassword(String password) {
		Mobile.setText(findTestObject('android/Login/inputPasswordLogin'), password, 0)
	}
